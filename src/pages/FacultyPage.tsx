...
export default function FacultyPage() {
  ...
  useSEO({
    title: faculty 
      ? `${faculty.name} - Notițe și Cursuri | StudyBuddy`
      : 'Facultate | StudyBuddy',
    description: faculty 
      ? `Notițe, cursuri și materiale de studiu pentru ${faculty.name} la ${faculty.university.name}. ${notesCount > 0 ? `${notesCount} notițe disponibile.` : 'Fii primul care încarcă notițe!'}`
      : 'Găsește notițe și cursuri pentru facultăți din România.',
    canonical: faculty 
      ? `https://www.studybuddy.ro/uni/${uniSlug}/${facultySlug}`
