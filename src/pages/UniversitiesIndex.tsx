...
export default function UniversitiesIndex() {
  ...
  return (
    <>
      <Helmet>
        <title>Universități din România - Notițe și Cursuri | StudyBuddy</title>
        <meta 
          name="description" 
          content="Descoperă notițe și materiale de studiu pentru universitățile din România. Găsește resurse pentru facultățile tale preferate." 
        />
        <meta property="og:title" content="Universități din România | StudyBuddy" />
        <meta property="og:description" content="Catalog de universități și facultăți cu notițe de studiu" />
        <link rel="canonical" href="https://www.studybuddy.ro/uni" />
      </Helmet>
