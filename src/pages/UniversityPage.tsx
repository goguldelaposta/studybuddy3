...
export default function UniversityPage() {
  ...
  useSEO({
    title: university 
      ? `${university.name} - Notițe și Cursuri | StudyBuddy`
      : 'Universitate | StudyBuddy',
    description: university 
      ? `Găsește notițe, cursuri și materiale de studiu pentru ${university.name} (${university.short_name}). Descoperă resurse pentru ${faculties.length} facultăți.`
      : 'Găsește notițe și cursuri pentru universități din România.',
    canonical: university 
      ? `https://www.studybuddy.ro/uni/${university.slug}`
